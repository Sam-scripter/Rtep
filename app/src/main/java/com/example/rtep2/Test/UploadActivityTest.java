...
public class UploadActivityTest extends AppCompatActivity {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK){
                            ...
                            try {
                                ...
                                Toast.makeText(UploadActivityTest.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                            uploadImage.setImageBitmap(bitmapImage);
                        } else {
                            Toast.makeText(UploadActivityTest.this, "No Image Selected", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
        );
...
//            dbHelper.storeData(new ModelClass(uploadName.getText().toString(), uploadEmail.getText().toString(), bitmapImage));
            Intent intent = new Intent(UploadActivityTest.this, Test.class);
